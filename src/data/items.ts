...
const sourceCatalog: Record<string, ItemSource> = {
  ...
  waterford: { label: 'Crystal care guide', publisher: 'Waterford', url: 'https://www.waterford.com/en-us/customer-service/care-guide' },
...
const itemSourceKeys: Record<string, string[]> = {
  ...
  'cast-iron-skillet': ['lodge'], 'crystal-glasses': ['waterford'], 'mason-jars': ['ball'],

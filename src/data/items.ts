...
export const items: DishItem[] = [
  ...
  {
    slug: 'air-fryer-basket', name: 'air fryer baskets and trays', aliases: ['air fryer tray', 'air fryer trays', 'air fryer drawer', 'air fryer crisper plate', 'air fryer basket in dishwasher', 'air fryer basket dishwasher safe', 'air fryer dishwasher safe'], verdict: 'depends',
